...
# ---------------------------------------------------------------------
# (O seu código de `listar_profissionais_func`, `listar_servicos_func`, 
# `calcular_horarios_disponiveis_func`, `criar_agendamento_func`, 
# e `tools = Tool(...)` está 100% preservado aqui)
    ...
    try:
        ...
        while response.candidates[0].content.parts and response.candidates[0].content.parts[0].function_call: # [cite: 204]
            ...
            if function_name in tool_map:
                ...
                # (Sua sintaxe 'protos' preservada) [cite: 218]
