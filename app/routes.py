...
from .whatsapp_client import WhatsAppClient, sanitize_msisdn  # IMPORT RELATIVO
...
def webhook():
    ...
    logging.info("PAYLOAD RECEBIDO: %s", data)
    ...
    try:
        ...
        from_number = sanitize_msisdn(message.get('from'))
        ...
        logging.error("Erro no webhook: %s", e, exc_info=True)
